package com.codefororlando.transport.controller.clustering;
 ...
 * hierarchical.
 * <p/>
 * High level algorithm:<br> 1. Iterate over items in the order they were added (candidate
 * clusters).<br> 2. Create a cluster with the center of the item. <br> 3. Add all items that are
 * within a certain distance to the cluster. <br> 4. Move any items out of an existing cluster if
 * they are closer to another cluster. <br> 5. Remove those items from the list of candidate
 * clusters.
 * <p/>
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private static class QuadItem<T extends ClusterItem> implements PointQuadTree.Item, Cluster<T> {
        ...
        public boolean equals(Object o) {
            ...
            return mClusterItem.equals(((QuadItem) o).mClusterItem);
        }
    }
}
